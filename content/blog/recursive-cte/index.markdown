...
<br>We can see that the recursive member here mainly plays a role in helping us identifying the next payer for whom we'd like to pull users he sent funds to. All the information added is just from the payments table, the recursion helps us iterate across the network.  
