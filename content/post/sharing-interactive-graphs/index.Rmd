...
And now we can write our file to our current working directory. The `knitrOptions` takes our height and width configuration - Play around with it until it's satisfactory for you; depends for what I need it but I find the default settings (seems like 100% width and 100% height) adequate for my needs. If you choose to go with the deafult, you don't need to set the height, width or the `KnitrOptions` in the following argument.
...
That's it! you can find your hosted html file at <span style="color:RoyalBlue;">username.github.io/repo-name/file.html</span>. For instance, the exmaple I used for this blogpost can be found here: [https://amitlevinson.github.io/TidyTuesday/2020/week17_gdpr/hc_gdpr.html](https://amitlevinson.github.io/TidyTuesday/2020/week17_gdpr/hc_gdpr.html)

Once you have a GitHub page you can do so much more with it (For e.g. host a personal website), but that's for a different post altogether. If you want to learn more about adding a theme to GitHub pages check out [this post](https://resources.github.com/whitepapers/github-and-rstudio/) by GitHub.
