---
title: Printing categorical variables with KableExtra
...
tags: []
subtitle: ''
summary: "Aestheticaly printing descriptive categorical variables from your data"
featured: no
image:
...
```{r fig.align='center', fig.cap='Example using kable_minimal as a table theme'}
...
```{r fig.cap='Outputting a table using df_print: kable in the YAML section'}
