...
{{<instagram B-rtY8bnKHx hidecaption >}}
![](ice-cream.jpg)
...
```{r fig.cap='Static map of distances to Golda ice-cream locations', echo = FALSE, fig.align='center'}
# Project the map
# isr_map <- st_transform(isr_map_sf, crs = 2039)
# # Make square grid
# new_isr <- st_make_grid(isr_map,  cellsize = 2000)
...
ggplot(golda_distances, color = "gray35")+
  ...
  #scale_fill_binned(high = "#FF1554", low = "#FFE5EC", n.breaks = 7)+
  scale_fill_manual(name = "Distance (km)", values = rev(pink_palette), labels = c("0-5", "5-10", "10-25", "25-50", "50-70"))+
  #scale_fill_gradient(high = "#FF1554", low = "#FFFFFF", breaks = seq(70,10,-10))+
  xlim(34,36)+
...
ggsave("binned.png", width = 5, height = 8)
```
...
ggplot(golda_distances_rds)+
  geom_sf(data = isr_map_rds_raw, color = "gray35")+
...
All this talk about ice-cream sure got me craving for one. I hope I didn't evoke too much ice-cream craving following this post, but at least now you know where to find the nearest location. I also invite you to explore the [full source code]() or play with the [data] yourself.
