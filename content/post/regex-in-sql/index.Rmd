---
title: Text Manipulation & RegEx in a Data Analysis flow (with examples in SQL and  R/Python)
...
Working as a Data Analyst in the fraud domain I constantly find myself manipulating text, for example to abstract a pattern we identified. At other times in personal projects a lot of cleaning is needed before being able to implement various algorithms such as [TF-IDF]. This is done with various text manipulations in SQL or locally in Python or R using regex and text manipulation functions. 
...
In this post We'll go over three scenarios I faced in the past, both in some coding language or while using SQL. As I've recently picked up Python I'll solve them using that (and some R), **but the general idea should be language agnostic, and that is using regex and working with text as data analysts.** 
