...
Working as a Data Analyst in the fraud domain I constantly find myself manipulating text, for example to abstract a pattern we identified. This is done with various text manipulation functions in SQL or locally in Python or R using regex and other functions. 
