...
While rockets were fired towards Israel I decided to take the opportunity and plot Be'er-Sheva's bomb shelters.  
...
So we have our data frame with long and lat points, let's get our map. I want a map the can be readable in terms of streets and roads, therefore I'll give the `ggmap` package a try[^1]. Google requires you to register in order to recieve an API key to pull maps to plot. Unfortunately I won't cover how to regiser in this blog but I'm sure you can find plenty of tutorials addressing it online.  
