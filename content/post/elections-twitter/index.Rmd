...
```{r echo = FALSE, fig.cap= "_Wordcloud excludes Hebrew stop words and the word 'elections'_", fig.align= 'center'}
...
```{r, fig.cap="_Bigram raph excludes Hebrew stop words and the word 'elections'_", fig.aling = 'center'}
