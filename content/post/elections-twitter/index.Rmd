...
16,560 rows and 90 columns! As we can see, the `{rtweet}` package brings back a lot of information (check out the `.rds` file [here](https://github.com/AmitLevinson/amitlevinson.com/tree/master/content/post/elections-twitter))!  
