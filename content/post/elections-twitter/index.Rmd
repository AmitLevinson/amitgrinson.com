...
Israel had its 3rd consecutive election (in a year!) on March 2, 2020, because our Knesset - Hebrew term for house of representatives - wasn't able to form or hold a government after each of the previous elections. As I won't get into the politics of why they didn't succeed in forming one (get it? politics :wink:), I do want to take the opportunity and analyze some tweets posted in the time before and after the elections.  
...
16,560 rows and 90 columns! As we can see, the `{rtweet}` package brings back a lot of information (You can also download the data at the bottom of the post)!  
...
If you wish to give it a try yourself, you can find the `.rds` file in my [github repository](https://github.com/AmitLevinson/amitlevinson.com/blob/master/content/post/elections-twitter/election_tweets.rds) or download a smaller `.csv` file here (excludes list columns):  
...
**And remember, make sure to validate your stop words dataset!**
<br>
<br>