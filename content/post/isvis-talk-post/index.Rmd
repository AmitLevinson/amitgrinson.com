...
During challenges that I brought my own data (e.g. 30day*) I realized eventually that when I brought data that was engaging to me I was more committed to participate. This broke down to two kinds of engagement, meaningful and personal

#### Meaningful <span class='grayit'>Data</span>

Meaningful is a subjective concept, where everyone views things as meaningful differently. As someone leaving in Israel I found data relating to Israel meaningful and relating to me. I was intruiged and challenged by it, and wanted to answer questions pertaining it as an Israeli.

[Image]

So I picked up various datasets relating to Israel, such as visualizing Israeli prime ministers and Israel's elevation. More recently I visualized population density in Israeli cities, a dataset I had laying around and wanted to look at for a while.

#### Personal <span class='grayit'>Data</span>

Meaningful also took form as data that recorded my behviour. Realizing that I collected and picked up various data ahead of time that I was eager to look at. For example as someone who uses Twitter mainly for R related things I was curious to see how much I use the #rstats hashtag, a hashtag associated with the R community. Alternatively currently living in Tel-Aviv I frequently visit the Dizengoff square, so I was curious to see how far can I walk at different time frames.
...
During the #30DayMapChallenge in 2019 Alexandra Kapp published a map of frequently traveled routes in Berlin. What she did was, to my interpertation, elegantly brilliant: She sampled two points in Berlin and calculated the fastest route between them. She did this for 500 pairs of points and plotted the routes traveled on with the line width representing the frequency of the street traveled compared to other streets.

Seeing this and amazed by its simplictiy I adapted it for my own needs: The next year I ran the same analysis on Tel-Aviv, producing the plot on the right.

While this was one example, adapting others' code is something prevalent in a coder's life: You find an answer on StackOverflow, copy the example in a GitHub repo documentation and more. Participating in these challenges de-facto motivated me to learn others' code, way of thinking and different approaches to the same data.
...
Sometimes it was even more subtles things, such as having a reprtoire of graphs to choose from or choosing the right one for the data I wanted to present. Either way, I realized that **participating in these challenges made me a better communicator and analyst 
