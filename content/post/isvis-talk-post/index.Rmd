...
I'll also take this opportunity to thank my wife — the night the call for talks closed I came to her and said "That's it, I'm not going to submit anything to ISVIS, I don't have anything to share". Luckily she convinced me otherwise, and this talk was born out of it. Thank you ❤️


## Data visualization challenges and their educational inspiration


I've actually come across data visualization challenges somewhat by chance. When I started thinking about MA thesis (somewhere in 2019) I realized I wanted to analyze it in something other than SPSS we learned, and was recommended to try out the R programming language.

But I didn't want to wait for my thesis data to arrive, only to be incompetent to analyze it; rather, I wanted to be capable analyzing it when the time came. This is also how I thought about learning R — By manipulating and analyzing data, which eventually led me to data visualization challenges.
...
While the two challenges differ, I found a lot in common: **Anyone and everyone are invited, beginners and advanced alike. Plot it in R, Python, Tableau, Qgis and whatnot. Despite not knowing almost anyone in real life constantly felt like I was part of a community.**
...
While this was one example, adapting others' code is something prevalent in a coder's life: You find an answer on Stack Overflow or in some GitHub repository and adapt it to your current need. 
...
So if I'll try to recap my experiences and what I took from these challenges, and why I think you too should join is because of the following:

1. **Welcoming community** — The community in the challenges I participated in were very welcoming. Come with any level of experience and tool you use. Everyone is welcome with no strings attached as to how frequently you should participate.  

2. **Interacting and being inspired by amazing people** — It's amazing how many people I learn about and got to interact with from these challenges. My Twitter feed has grown immensly with many of these people I learn from in these challenges and work they continue to share thereafter.  

3. **Invitation to leave your comfort zone and challenge yourself** — This challenges, in effect, constantly push your limits. A new dataset, a new function or new tool altogether; every theme comes with new and exciting challenges to overcome and learn from.  

4. **Explore various data** — Since you bring your own data to some of these challenges it's a great opportunity to explore data you had laying around or something personal.  

5. **Gain experience and confidence** — Overcoming various challenges in each submission you get better and gain more confidence. I recall having it pretty easy exploring datasets for take-home tests when I searched for a job considering I did it plenty beforehand in some of these challenges.   

6. **Create something to call your own** — The best part of participating in these challenges is suddenly you have this great and diverse portfolio to share with others. Just set up a simple [webpage and host all your contributions](https://amitlevinson.com/data-visualization/) there!
...
Well, you just start! Seriously, there's many challenges out there all the time. #TidyTuesday project, #MakeOverMonday, #StorytellingWithData (SWD), Vis4SocialGood, 30DayChartChallenge, 30DayMapChallenge and more!
