...
```{r echo=FALSE, fig.cap='Descriptive statistics benchmarking 100 iterations of each possible answer'}
...
ggplot(data = data.frame(expr = benchmarking$expr, time = benchmarking$time / 1e6))+
  ...
  labs(title = "Benchmarking different solutions",
       subtitle = "Values are from 100 iterations of each solution on a 2,000 observation table",
       x = NULL)
```
